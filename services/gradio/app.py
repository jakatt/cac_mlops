...
def build_docs_html() -> str:
    ...
    docs = [
        ...
        (f"{PUBLIC_BASE}/ci-docs/tests_catalogue.html", "Catalogue des tests",
         "54 tests unitaires CI (11 API + 43 ETL/Data) · pipeline CD · 6 tests Prefect post-deploy", "tests_catalogue.html"),
        (f"{PUBLIC_BASE}/ci-docs/etl_catalogue.html", "Catalogue ETL",
         "Détail des 5 grandes étapes du pipeline ETL (Trigger 1) — téléchargement, validation, DVC, preprocessing",
         "etl_catalogue.html"),
